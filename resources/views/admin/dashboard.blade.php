...
<div class="row g-4 mb-4">
    <div class="col-xl-3 col-md-6">
        <div class="stat-card stat-card-blue">
            ...
            <div class="stat-card-info">
                <div class="stat-card-number">{{ $stats['total_tickets'] }}</div>
                <div class="stat-card-label">Total Tickets</div>
            </div>
            <div class="stat-card-sub">
                <span class="text-success">{{ $stats['available_tickets'] }} available</span>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="stat-card stat-card-gold">
            ...
            <div class="stat-card-info">
                <div class="stat-card-number">{{ $stats['total_vendors'] }}</div>
                <div class="stat-card-label">Total Vendors</div>
            </div>
            <div class="stat-card-sub">
                @if($stats['pending_vendors'] > 0)
                    <span class="text-warning">{{ $stats['pending_vendors'] }} pending review</span>
                @else
    ...
    <div class="col-xl-3 col-md-6">
        <div class="stat-card stat-card-green">
            ...
            <div class="stat-card-sub">
                <span class="text-warning">{{ $stats['pending_bookings'] }} pending</span>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="stat-card stat-card-purple">
            ...
            <div class="stat-card-info">
                <div class="stat-card-number">PKR {{ number_format($stats['total_revenue']) }}</div>
                <div class="stat-card-label">Total Revenue</div>
            </div>
            <div class="stat-card-sub">
                @if($stats['pending_payments'] > 0)
                    <span class="text-warning">{{ $stats['pending_payments'] }} payment(s) pending</span>
                @else
...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="mini-stat-card">
            ...
            <span>{{ $stats['hold_tickets'] }} tickets on hold</span>
        </div>
    </div>
    <div class="col-md-4">
        <div class="mini-stat-card">
            <i class="fas fa-check-circle text-success me-2"></i>
            <span>{{ $stats['approved_vendors'] }} approved vendors</span>
        </div>
    </div>
    <div class="col-md-4">
        <div class="mini-stat-card">
            <i class="fas fa-ban text-danger me-2"></i>
            <span>{{ $stats['booked_tickets'] }} tickets booked</span>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-7">
        <div class="admin-table-card">
            <div class="admin-table-header">
                ...
                <a href="{{ route('admin.bookings.index') }}" class="btn-view-all">View All</a>
            </div>
                ...
                <table class="table admin-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-truncate" style="max-width:150px">{{ $booking->ticket->title ?? '—' }}</td>
    ...
    <div class="col-lg-5">
        ...
        <div class="admin-table-card mb-4">
            <div class="admin-table-header">
                ...
                <a href="{{ route('admin.vendors.index') }}?status=pending" class="btn-view-all">View All</a>
            </div>
            @forelse($pendingVendors as $vendor)
            <div class="pending-item">
                <div class="pending-avatar"><i class="fas fa-building"></i></div>
                <div class="flex-grow-1 min-w-0">
                    <div class="fw-semibold text-truncate">{{ $vendor->company_name }}</div>
                    <small class="text-muted">{{ $vendor->email }}</small>
                </div>
                <a href="{{ route('admin.vendors.show', $vendor) }}" class="btn-mini-action">Review</a>
            </div>
            @empty
        ...
        <div class="admin-table-card">
            <div class="admin-table-header">
                ...
                <a href="{{ route('admin.payments.index') }}?status=pending" class="btn-view-all">View All</a>
            </div>
            @forelse($recentPayments as $payment)
            <div class="pending-item">
                <div class="pending-avatar payment-avatar"><i class="fas fa-credit-card"></i></div>
                <div class="flex-grow-1 min-w-0">
                    <div class="fw-semibold">PKR {{ number_format($payment->amount) }}</div>
                    <small class="text-muted">{{ ucfirst($payment->method) }} · {{ $payment->created_at->diffForHumans() }}</small>
                </div>
                <a href="{{ route('admin.payments.show', $payment) }}" class="btn-mini-action">Verify</a>
            </div>
            @empty
