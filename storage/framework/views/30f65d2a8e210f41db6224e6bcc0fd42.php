...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'AirArabian - Premium Airline Ticketing'); ?></title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center gap-1">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>#tickets">
                        <i class="fas fa-ticket-alt me-1"></i>Flights
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>?category=Umrah">
                        <i class="fas fa-kaaba me-1"></i>Umrah
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>?category=Tour">
                        <i class="fas fa-globe me-1"></i>Tours
                    </a>
                </li>
                <li class="nav-item ms-2">
                    <a class="btn btn-gold" href="<?php echo e(route('vendor.inquiry')); ?>">
                        <i class="fas fa-handshake me-1"></i>Become a Vendor
                    </a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-outline-gold ms-1" href="<?php echo e(route('vendor.login')); ?>">
...
<footer class="site-footer">
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-sm-6">
                ...
                <ul class="footer-links">
                    <li><a href="<?php echo e(route('home')); ?>?category=UAE">UAE Flights</a></li>
                    <li><a href="<?php echo e(route('home')); ?>?category=KSA">KSA Flights</a></li>
                    <li><a href="<?php echo e(route('home')); ?>?category=Umrah">Umrah Packages</a></li>
                    <li><a href="<?php echo e(route('home')); ?>?category=Tour">Tour Packages</a></li>
                </ul>
            </div>
            <div class="col-lg-2 col-sm-6">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo e(route('vendor.inquiry')); ?>">Become a Vendor</a></li>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <p class="text-muted mb-0">&copy; <?php echo e(date('Y')); ?> AirArabian. All rights reserved.</p>
...
<?php /**PATH C:\Users\muneeb ahmed\Desktop\Travel_Portal\resources\views/layouts/app.blade.php ENDPATH**/ ?>